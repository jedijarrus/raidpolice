...
const MAJOR_COOLDOWNS = {
  // Warrior
  recklessness:      { ids:[1719],          name:'Recklessness',         role:'dps',  cd:1800, cls:'Warrior' },
  deathWish:         { ids:[12292],         name:'Death Wish',           role:'dps',  cd:180,  cls:'Warrior' },
  shieldWall:        { ids:[871],           name:'Shield Wall',          role:'tank', cd:1800, cls:'Warrior' },
  lastStand:         { ids:[12975],         name:'Last Stand',           role:'tank', cd:480,  cls:'Warrior' },
  // Rogue
  adrenalineRush:    { ids:[13750],         name:'Adrenaline Rush',      role:'dps',  cd:300,  cls:'Rogue' },
  bladeFlurry:       { ids:[13877],         name:'Blade Flurry',         role:'dps',  cd:120,  cls:'Rogue' },
  coldBlood:         { ids:[14177],         name:'Cold Blood',           role:'dps',  cd:180,  cls:'Rogue' },
  preparation:       { ids:[14185],         name:'Preparation',          role:'dps',  cd:600,  cls:'Rogue' },
  // Hunter
  bestialWrath:      { ids:[19574],         name:'Bestial Wrath',        role:'dps',  cd:120,  cls:'Hunter' },
  rapidFire:         { ids:[3045],          name:'Rapid Fire',           role:'dps',  cd:300, cls:'Hunter' },
  readiness:         { ids:[23989],         name:'Readiness',            role:'dps',  cd:300, cls:'Hunter' },
  // Mage
  combustion:        { ids:[11129],         name:'Combustion',           role:'dps',  cd:180, cls:'Mage' },
  arcanePower:       { ids:[12042],         name:'Arcane Power',         role:'dps',  cd:180, cls:'Mage' },
  icyVeins:          { ids:[12472],         name:'Icy Veins',            role:'dps',  cd:180, cls:'Mage' },
  presenceOfMind:    { ids:[12043],         name:'Presence of Mind',     role:'dps',  cd:180, cls:'Mage' },
  coldSnap:          { ids:[11958],         name:'Cold Snap',            role:'dps',  cd:600, cls:'Mage' },
  evocation:         { ids:[12051],         name:'Evocation',            role:'dps',  cd:480, cls:'Mage' },
  // Priest
  innerFocus:        { ids:[14751],         name:'Inner Focus',          role:'any',  cd:180, cls:'Priest' },
  shadowfiend:       { ids:[34433],         name:'Shadowfiend',          role:'any',  cd:300, cls:'Priest' },
  powerInfusion:     { ids:[10060],         name:'Power Infusion',       role:'any',  cd:120, cls:'Priest' },
  painSuppression:   { ids:[33206],         name:'Pain Suppression',     role:'heal', cd:120, cls:'Priest' },
  devouringPlague:   { ids:[2944,19276,19277,19278,19279,19280,25467], name:'Devouring Plague', role:'dps', cd:180, cls:'Priest' },
  // Paladin
  avengingWrath:     { ids:[31884],         name:'Avenging Wrath',       role:'any',  cd:180, cls:'Paladin' },
  divineFavor:       { ids:[20216],         name:'Divine Favor',         role:'heal', cd:120, cls:'Paladin' },
  layOnHands:        { ids:[633,2800,10310,27154], name:'Lay on Hands',  role:'heal', cd:2400, cls:'Paladin' },
  divineShield:      { ids:[642],           name:'Divine Shield',        role:'tank', cd:300, cls:'Paladin' },
  divineProtection:  { ids:[498,5573],      name:'Divine Protection',    role:'tank', cd:300, cls:'Paladin' },
  // Druid
  forceOfNature:     { ids:[33831],         name:'Force of Nature',      role:'dps',  cd:180, cls:'Druid' },
  naturesSwiftness:  { ids:[17116],         name:"Nature's Swiftness",   role:'any',  cd:180, cls:'Druid' },
  innervate:         { ids:[29166],         name:'Innervate',            role:'heal', cd:360, cls:'Druid' },
  tranquility:       { ids:[740,8918,9862,9863,26983], name:'Tranquility', role:'heal', cd:480, cls:'Druid' },
  rebirth:           { ids:[20484,20739,20740,20741,20742,26994], name:'Rebirth', role:'heal', cd:1200, cls:'Druid' },
  frenziedRegen:     { ids:[22842,22895,22896,26999], name:'Frenzied Regeneration', role:'tank', cd:180, cls:'Druid' },
  // Shaman
  elementalMastery:  { ids:[16166],         name:'Elemental Mastery',    role:'dps',  cd:180, cls:'Shaman' },
  shamanisticRage:   { ids:[30823],         name:'Shamanistic Rage',     role:'dps',  cd:120, cls:'Shaman' },
  manaTide:          { ids:[16190,17355,17354,39609], name:'Mana Tide Totem', role:'heal', cd:300, cls:'Shaman' },
  // Racials — verfügbar für alle Klassen (Race-dependent), keine Klassen-Restriktion
  bloodFury:         { ids:[20572,33697,33702], name:'Blood Fury',       role:'any',  cd:120, cls:'*' },
  berserking:        { ids:[26297],         name:'Berserking',           role:'any',  cd:180, cls:'*' },
  // Fear Ward (Priest base + Dwarf/Draenei racial) — alle Klassen mit Dwarf/Draenei haben es als Racial
  fearWard:          { ids:[6346],          name:'Fear Ward',            role:'any',  cd:180, cls:'*' },
};
